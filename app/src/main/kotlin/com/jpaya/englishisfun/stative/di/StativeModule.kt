...
package com.jpaya.englishisfun.stative.di

import com.jpaya.englishisfun.firestore.FireStoreClient
import com.jpaya.englishisfun.stative.data.db.DatabaseDataSource
import com.jpaya.englishisfun.stative.data.db.StativeDao
import com.jpaya.englishisfun.stative.data.network.NetworkDataSource
import com.jpaya.englishisfun.stative.domain.StativeInteractor
import com.jpaya.englishisfun.stative.ui.StativePresenter
...
class StativeModule {
    ...
    /**
     * Create a provider method binding for [StativePresenter].
     *
     * @return Instance of presenter.
     */
    @Provides
    fun providesListPresenter(interactor: StativeInteractor) = StativePresenter(interactor)

    /**
     * Create a provider method binding for [StativeInteractor].
     *
     * @return Instance of interactor.
     */
    @Provides
    fun providesInteractor(network: NetworkDataSource, database: DatabaseDataSource) =
        StativeInteractor(network, database)
