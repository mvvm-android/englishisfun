...
package com.jpaya.englishisfun.abbreviations.adapter.holders
...
) : BaseViewHolder<AbbreviationsListItemBinding>(
    binding = AbbreviationsListItemBinding.inflate(inflater)
) {
