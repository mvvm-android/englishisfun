...
class ConditionalsModuleTest {

    private lateinit var module: ConditionalsModule

    @Before
    fun setUp() {
        module = ConditionalsModule()
    }
    ...
    @Test
    fun `Check provided interactor`() = assertNotNull(module.providesConditionalsInteractor(mock(), mock()))
