...
package com.jpaya.core.ui.livedata

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import androidx.lifecycle.LifecycleOwner
import com.jpaya.core.ui.extensions.observe
...
class SingleLiveDataTest {
    ...
    fun observingSingleLiveData_WhenPostStringValue_ShouldTriggerOneEvent() {
        val singleLiveData = com.jpaya.core.ui.livedata.SingleLiveData<String>()
    ...
    fun observingSingleLiveData_WhenPostMultipleIntValue_ShouldTriggerMultipleTimes() {
        val singleLiveData = com.jpaya.core.ui.livedata.SingleLiveData<Int>()
